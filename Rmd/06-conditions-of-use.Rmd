...
Whenever you use this dataset in your research, please **include your publications 1) an acknowledgement of the CARDAT platform** (a suggested wording can be found [here][cardat-acknowledgements]) and **2) citation of the dataset itself**:
...
We would greatly appreciate being informed ([email us!][cardat-email]) of any publications as this helps us to track usage and report back to the contributing agencies.


Note the data has been provided by Australian state and territory governments, and are therefore subject to differing licences, conditions of use and disclaimers. When using data **please abide by the the relevant licensing and conditions of use set out by each agency**, in addition to the conditions of use of NAPMD above. 
